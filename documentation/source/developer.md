...
The full source code for the BJCree font is available on Github:

- [BJCree Github repository](https://github.com/silnrsi/font-bjcree)
...
- Additional characters for the UCAS Extended and UCAS Extended-A blocks
